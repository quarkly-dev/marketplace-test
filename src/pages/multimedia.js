			...
			<Stack gap="16px" margin="0px -16px 0px 0px">
				...
				<StackItem width="100%" display="flex">
					...
					<Text
						...
						lg-width="80%"
					>
						Components that are associated with the content part of the site, which work more with the information that you present to the client (sliders, prices, tables, etc.)
					</Text>
					{"    "}
				</StackItem>
			</Stack>
		...
		<Section background="--color-darkL1" padding="0px 0 200px 0" sm-padding="24px 0 24px 0">
			<Stack gap="0px">
				...
				<StackItem width="100%" display="flex" lg-width="100%">
					...
					{"     "}
					<Stack margin="0px 0px 0px 0px" gap="16px" sm-padding="0px 0px 0px 0px">
						{"    "}
