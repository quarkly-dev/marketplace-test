									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Автоматически публиковать комментарии на странице пользователя
											</Text>
										</Box>
										<Box
											width="15%"
									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												URL страницы, которая будет прикреплена к сообщению пользователя, если включена автоматическая публикация
											</Text>
										</Box>
										<Box
											width="15%"
									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Пользователь может прикрепить граффити к сообщению
											</Text>
										</Box>
										<Box
											width="15%"
									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Пользователь может прикрепить фотографию к сообщению
											</Text>
										</Box>
										<Box
											width="15%"
									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Пользователь может прикрепить аудио к сообщению
											</Text>
										</Box>
										<Box
											width="15%"
									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Пользователь может прикрепить видео к сообщению
											</Text>
										</Box>
										<Box
											width="15%"
									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Пользователь может прикрепить ссылку к сообщению
											</Text>
										</Box>
										<Box
											width="15%"
