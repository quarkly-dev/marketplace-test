		...
		<Section background="rgba(0, 0, 0, 0) linear-gradient(0deg, rgb(14, 19, 23) 0%, rgb(34, 38, 46) 100%) repeat scroll 0% 0% / auto padding-box border-box" padding="24px 0 40px 0" sm-padding="24px 0 60px 0">
			<Stack gap="--cmp-stack-gap-default" margin="0px -16px 0px 0px" width="100%">
				...
				<StackItem width="40%" display="flex" md-display="none">
					...
					{"        "}
					<Image src="https://uploads.quarkly.io/5f9aba1d8da982001e8c48e0/images/timeline.svg?v=2020-11-02T20:24:16.347Z" object-position="100% 100%" width="90%" />
					{"    "}
				</StackItem>
			</Stack>
		</Section>
				...
				<StackItem width="100%" display="flex" lg-width="100%">
					...
					<Stack margin="0px 0px 0px 0px" gap="16px">
						...
						<StackItem width="100%" display="flex">
							...
							/>
							<Components.Timeline items="4">
								<Override slot="Timeline Dates" color="#ffffff" />
								<Override slot="Timeline Title" color="--primary" />
							</Components.Timeline>
						</StackItem>
						{"    "}
					</Stack>
									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Alignment of items  on the desktop
											</Text>
										</Box>
										<Box
											width="30%"
									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Выравнивание элементов на мобильных{"  "}
											</Text>
										</Box>
										<Box
											width="15%"
									...
									<Box display="flex">
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Задать breakpoint, на котором переключается мобильная версия компонента{"\n\n"}
											</Text>
										</Box>
										<Box
											width="15%"
										...
										>
											<Text
												...
												text-shadow="0px 4px 4px rgba(0, 0, 0, 0.25)"
											>
												Название breakpoint из доступных в теме проекта
											</Text>
										</Box>
									</Box>
								</Box>
