export default {
	...
	"fontFamily": {
		...
		"googleRobotoMono": "Roboto Mono, monospace",
		"googleSourceCodePro": "Source Code Pro, monospace"
	},
	"font": {
		"headline1": "normal 600 90px/86px --fontFamily-googleSourceSansPro",
		"headline2": "normal 900 42px/1.2 --fontFamily-sans",
		"headline3": "normal 600 36px/45px --fontFamily-googleSourceSansPro",
		"base": "normal 300 16px/1.5 --fontFamily-sans",
		"lead": "normal 400 24px/30px --fontFamily-googleSourceSansPro",
		"menu": "600 14px/17px --fontFamily-googleSourceSansPro",
		"buttom": "700 14px/17px --fontFamily-googleSourceSansPro",
		"headline4": "600 20px/25px --fontFamily-googleSourceSansPro"
	},
	"boxShadow": {
