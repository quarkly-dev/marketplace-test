...
const TimelineItem = ({
	...
	>
		...
		<Text margin="0 0 8px" font="--font-base" color="#fff" {...override('Timeline Dates', `Timeline ${numb} Dates`)}>
			        
			{override(`Timeline ${numb} Dates`).children || '18:00 - 20:30'}
			      
		</Text>
		      
		<Text margin="0 0 6px" font="--font-headline3" color="#fff" {...override('Timeline Title', `Timeline ${numb} Title`)}>
			        
			{override(`Timeline ${numb} Title`).children || 'Desktop vs mobile'}
			      
		</Text>
		      
		<Text margin="0" font="--font-base" color="#fff" {...override('Timeline Descr', `Timeline ${numb} Descr`)}>
